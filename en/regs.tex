...
\item At the beginning of each match, robots must fit within a cube with $500mm$ internal sides.
      \textit{During the match}, the robot may extend beyond this size. This only includes the size of the robot and not a token which may optionally be place in/on the robot before the start of the match. 
